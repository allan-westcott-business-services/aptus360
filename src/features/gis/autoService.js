...
export function layServices(features = [], utility, opts = {}) {
  ...
  /* Reached directly, or through the pieces between — one walk, shared
     with serviceTrenchCheck, which had the same fault and would have
     grown a second copy of the fix. See servicesReachingMains. */
  const reach = servicesReachingMains(services, mains, teeM);
