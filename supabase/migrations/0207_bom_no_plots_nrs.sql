-- Plots and non-residential supplies off the bill of materials.
--
-- Rebuilt from 0205 rather than patched, for the reason 0205 gives: one
-- function, and no replacing half of it. The body below is 0205's with
-- ONE word added to the exclusion list and nothing else touched.
--
-- \u2500\u2500 What a bill of materials is for \u2500\u2500
--
-- It lists what somebody has to buy and lay. A plot seed is a marker
-- saying a dwelling exists; a non-residential supply is a record of a
-- connection somebody has asked for. Neither is a thing that arrives on
-- a lorry, and counting them puts numbers on a take-off that no
-- quantity surveyor can price.
--
-- Plots were already excluded here (since 0167). NRS was not: it fell
-- through to initcap('nrs') and read "Nrs" \u2014 a line item named after
-- an acronym nobody would recognise, counting supplies as though they
-- were units of plant.
